export default _.merge({}, store.tpl.page, store.tpl.data, {
  state: {
    form: {
      url: {
        detail: "system/process/admin-log-detail",
        update: "system/process/admin-log-update",
      },
      loading: false,
      items: [
        {field: "id", label: "ID", tpl: "input",span:24},
        {field: "route", label: "Route", tpl: "input",span:24},
        {field: "description", label: "Description", tpl: "input",span:24},
        {field: "created_at", label: "Created At", tpl: "input",span:24},
        {field: "user_id", label: "User ID", tpl: "input",span:24},
      ],
      rules: {
        name: [
